...
function startPythonBackend() {
    ...
    // '__dirname' is the directory of the current file ('frontend'), so '..' goes up one level to the root.
    const scriptPath = path.join(__dirname, '..', 'service', 'app.py');
    
    // Use 'spawn' to execute the Python script as a separate process.
    // 'python3' is the command to run. This might need to be changed to 'python' on some systems.
