        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            try:
                ...
                if mp3_file:
                    ...
                    encoded_filename = encoded_filename = sanitize_filename_header(mp3_file) # Use helper
                ...
                return jsonify({"error": f"yt-dlp failed: {e.stderr[:500]}"}), 500 # Return beginning of stderr
